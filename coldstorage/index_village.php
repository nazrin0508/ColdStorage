        ...
        <?php include 'topbar.php' ?>
            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                ...
                <div class="intro-y col-span-12 lg:col-span-12">
                            ...
                            data-tw-target="#header-footer-modal-preview-view">Village</button>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                                <input id="txt_village_id" name="txt_village_id" type="hidden" class="form-control" placeholder="Village Id" readonly>
                                                <div class="col-span-12 sm:col-span-12">
                                                    <label for="txt_village_name" class="form-label">Village</label>
                                                    <input id="txt_village_name" name="txt_village_name" type="text" class="form-control" placeholder="Enter your Village">
                                                </div>
                                                <div class="col-span-12 sm:col-span-12">
                                                    <label for="txt_post" class="form-label">Post</label>
                                                    <input id="txt_post" name="txt_post" type="text" class="form-control" placeholder="Enter your post">
                                                </div>
                                                <div class="col-span-12 sm:col-span-12">
                                                    <label for="txt_anchal" class="form-label">Anchal</label>
                                                    <input id="txt_anchal" name="txt_anchal" type="text" class="form-control" placeholder="Enter your Anchal">
                                                </div>
                                                <div class="col-span-12 sm:col-span-12">
