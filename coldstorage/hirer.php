                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box p-5">
                            <div>
                                <label for="crud-form-1" class="form-label">Hirer Name</label>
                                <input id="crud-form-1" type="text" class="form-control w-full" placeholder="Input text">
                                
                            </div>
                            <div class="mt-3">
                                <label for="crud-form-2" class="form-label">Father's Name</label>
                                <input id="crud-form-1" type="text" class="form-control w-full" placeholder="Input text">
                                
                            </div>
                            <div class="mt-3">
                                <label for="crud-form-3" class="form-label">A/C off</label>
                                <div class="input-group">
                                    <input id="crud-form-3" type="text" class="form-control" placeholder="" aria-describedby="input-group-1">
                            ...
                            <div class="mt-3">
                            <label for="crud-form-4" class="form-label">Marketing</label>
                                <select id="group-hirer" name="group_hirer" class="form-select w-full">
                                ...
                                <div class="mt-3">
                                <label for="crud-form-2" class="form-label">VoterId/PanNo</label>
                                <input id="crud-form-1" type="text" class="form-control w-full" placeholder="Input text">
                            ...
                            <div class="text-right mt-5">
                                ...
                                <button type="button" class="btn btn-primary w-24">Update</button>
