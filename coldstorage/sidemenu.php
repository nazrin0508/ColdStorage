        ...
        <!--<div class="flex mt-[4.7rem] md:mt-0">-->
            ...
            <nav class="side-nav">
                <a href="" class="intro-x flex items-center pl-5 pt-4">
                    ...
                    <span class="hidden xl:block text-white text-lg ml-3"> Cold Storage </span> 
                </a>
                ...
                <ul>
                    ...
                    <!--<li>
                        ...
                        <ul class="">
                            <li>
                                <a href="side-menu-light-dashboard-overview-1.php" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
					...
					<li>
                        ...
                        <li>
                            ...
                            <li>
                                <a href="podist.php" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                    <div class="side-menu__title"> Post/Anchal/District </div>
                                </a>
                            </li>
                            <li>
                                <a href="remark.php" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                    <div class="side-menu__title"> Remark/Receiver/Log... </div>
                                </a>
                            </li>
							<li>
                                <a href="items.php" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                    <div class="side-menu__title"> Item Master </div>
                                </a>
                            </li>
							<li>
                                <a href="rack.php" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                    <div class="side-menu__title"> Rack Master </div>
                                </a>
                            </li>
							<li>
                                <a href="chember.php" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                    <div class="side-menu__title"> Chember/Floor </div>
                                </a>
                            </li>
							<li>
                                <a href="password.php" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                    <div class="side-menu__title"> Password </div>
                                </a>
                            </li>
                        </ul>
                    </li>
